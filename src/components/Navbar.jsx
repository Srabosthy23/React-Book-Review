...
const Navbar = () => {
    ...
    const link = <>
        ...
        <li><NavLink to={"/review"} className={({isActive}) => isActive? "text-green-500 border border-green-500 font-bold" : "font-normal"}>Review</NavLink></li>
        <li><NavLink to={"/faq"} className={({isActive}) => isActive? "text-green-500 border border-green-500 font-bold" : "font-normal"}>FAQ</NavLink></li>
